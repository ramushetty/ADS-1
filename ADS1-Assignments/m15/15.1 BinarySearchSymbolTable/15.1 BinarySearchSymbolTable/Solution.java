...
public final class Solution {
    ...
    public static void main(final String[] args) {
        ...
        BSST<String, Integer> st;
        st = new BSST<String, Integer>();
        ...
        while (scan.hasNextLine()) {
            ...
            case "max":
                ...
                break;
            case "floor":
                System.out.println(st.floor(split[1]));
                break;
            case "rank":
                System.out.println(st.rank(split[1]));
                break;
            case "deleteMin":
                st.deleteMin();
                break;
            case "contains":
                System.out.println(st.contains(split[1]));
                break;
            case "keys":
